...
from models import Comment, CommentVote, User, CommentReport
from schemas import CommentReportCreate
from auth import get_current_user

router = APIRouter()

class VoteRequest(BaseModel):
    vote_type: str  # 'up', 'down', 'none'
...
def vote_comment(
    ...
    final_user_vote = vote_request.vote_type
    
    if existing_vote:
        # If trying to exact same vote, toggle off (remove it)
